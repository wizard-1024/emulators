...
/* decimal */
#define M20_MANTISSA_SHIFT      64    
#define MIN_EXPONENT_VALUE     -64
#define MAX_EXPONENT_VALUE     63
#define MAX_EXP_MACHINE_VAL    (MAX_EXPONENT_VALUE+M20_MANTISSA_SHIFT)
/* octal */
#define EXP_OVF_VALUE          0100   
#define EXPONENT_VALUE_MASK   0177
...
#define MOSU_MODE_II_SPEC_BASE_ADDR  07770


/*
 * Machine code (word) bit definitions
 */
#define BIT46		01000000000000000LL	/* bit 46 */
#define TAG		00400000000000000LL	/* bit 45: number tag */
#define SIGN		00200000000000000LL	/* bit 44: mantissa/code sign */
#define BIT38		00002000000000000LL	/* bit 38 */
#define BIT37		00001000000000000LL	/* bit 37 */
#define BIT36		00000400000000000LL	/* bit 36: highest bif of mantissa */
#define BIT19		00000000001000000LL	/* bit 19 */
#define BIT01		00000000000000001LL	/* bit 01 */
#define WORD12	        00000000000007777LL	/* bits 12..1 */
#define WORD18	        00000000000777777LL	/* bits 18..1 */
#define WORD21	        00000000007777777LL	/* bits 21..1 */
#define WORD24	        00000000077777777LL	/* bits 24..1 */
#define WORD44		00377777777777777LL	/* bits 44..1 */
#define WORD45		00777777777777777LL	/* bits 45..1 */
#define MANTISSA	00000777777777777LL	/* bits 36..1 */
#define EXPONENT        00177000000000000LL     /* bits 43..37 */
#define EXPONENT_SIGN   00100000000000000LL     /* bits 43 */
#define EXP_SIGN_TAG    00777000000000000LL     /* bits 45..37 */
...
/*
 * Condional number bits to access of external device
 */
#define EXT_DIS_RAM	04000	/* 36 - BM - block memory */
#define EXT_DIS_CHECK	02000   /* 35 - BK - block control (checksum) */
#define EXT_TAPE_REV	01000   /* 34 - RT - reverse tape movement */
#define EXT_DIS_STOP	00400   /* 33 - BS - block stop */
#define EXT_PUNCH	00200   /* 32 - PU - punch */
#define EXT_PRINT	00100   /* 31 - PR - print */
#define EXT_TAPE_FORMAT	00040   /* 30 - FT - tape formatting */
#define EXT_TAPE	00020   /* 29 - T  - tape */
#define EXT_DRUM	00010   /* 28 - D  - drum */
#define EXT_WRITE	00004   /* 27 - WR - write */
#define EXT_UNIT	00003   /* 26..25 - drum or tape logical number */


/* IS-2 addresses */
#define  IS2_START_ADDRESS    07200
#define  IS2_END_ADDRESS      07767
...
enum {
	...
	STOP_IBKPT,				/* breakpoint */
        STOP_MEM,                               /* breakpoint   (memory access) */
        STOP_INSTR,                             /* breakpoint   (instruction access) */
